package es.juanlsanchez.bm.web.util.pagination;
...
public class PaginationUtil {
	...
	if ((page.getNumber()
	    ...
	    link = "<"
		    + generateUri(baseUrl, page.getNumber()
			    + 1, page.getSize())
		    + ">; rel=\"next\",";
	}
	// prev link
	...
	link += "<"
		+ generateUri(baseUrl, lastPage, page.getSize())
		+ ">; rel=\"last\",";
	link += "<"
		+ generateUri(baseUrl, 0, page.getSize())
		+ ">; rel=\"first\"";
