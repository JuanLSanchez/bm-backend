...
@Component
public class DefaultUserJTManager implements UserJWTManager {

    private final TokenProvider tokenProvider;
    private final AuthenticationManager authenticationManager;

    @Inject
    public DefaultUserJTManager(final TokenProvider tokenProvider, final AuthenticationManager authenticationManager) {
