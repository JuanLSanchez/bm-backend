package es.juanlsanchez.bm.unit.web.rest;
...
import es.juanlsanchez.bm.web.rest.UserJWTController;
...
public class JWTTest {
	...
	ResultActions result = this.mvc.perform(post(AUHENTICATION_URL).accept(MediaType.APPLICATION_JSON_UTF8)
	...
	assertThat(result.andReturn()
		.getResponse()
		.getHeader(JWTConfigurer.AUTHORIZATION_HEADER)).isNotNull();
	assertThat(result.andReturn()
		.getResponse()
		.getHeader(JWTConfigurer.AUTHORIZATION_HEADER)
		.matches("^Bearer "));
    }
